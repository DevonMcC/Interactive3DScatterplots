my3DChart.prototype = new DexComponent();
my3DChart.constructor = my3DChart;

function my3DChart(userConfig)
...
my3DChart.prototype.render = function()
{ this.update();
};

my3DChart.prototype.update = function()
{ var chart  = this.chart;
  var config = this.config;
  var csv    = config.csv;

  var numericColumns = dex.csv.getNumericColumnNames(csv);
